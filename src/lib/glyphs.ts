...
export const GLYPHS: Record<string, string> = {
  ...
  // ── Menu marks ──────────────────────────────────────────────────────────
  info: 'M12 3.5 a8.5 8.5 0 1 0 0.01 0 M12 10.5 v6.5 M12 7.2 v0.6',
  compass: 'M12 3 a9 9 0 1 0 0.01 0 M15.5 8.5 L13.5 13.5 L8.5 15.5 L10.5 10.5 Z',
  share: 'M18 3.5 a2.6 2.6 0 1 0 0.01 0 M6 9.4 a2.6 2.6 0 1 0 0.01 0 M18 18.4 a2.6 2.6 0 1 0 0.01 0 M8.4 10.7 L15.6 6.2 M8.4 13.3 L15.6 17.8',
  sky: 'M7.5 17.5 a4 4 0 0 1 0.6 -8 a5.5 5.5 0 0 1 10.4 2.2 a3 3 0 0 1 -0.5 5.8 Z M12 3.5 v1.8 M5 6 l1.3 1.3 M19 6 l-1.3 1.3',
  tour: 'M3.5 6.5 h17 v12 h-17 Z M3.5 6.5 L7 3.5 M9 6.5 L12.5 3.5 M14.5 6.5 L18 3.5 M9.5 10 l5 2.5 l-5 2.5 Z',
  settings: 'M12 9 a3 3 0 1 0 0.01 0 M12 2.5 v2.6 M12 18.9 v2.6 M2.5 12 h2.6 M18.9 12 h2.6 M5.3 5.3 l1.9 1.9 M16.8 16.8 l1.9 1.9 M18.7 5.3 l-1.9 1.9 M7.2 16.8 l-1.9 1.9',
  tools: 'M14.5 3.5 a4.5 4.5 0 0 0 -5.8 5.8 L3.5 14.5 v6 h6 l5.2 -5.2 a4.5 4.5 0 0 0 5.8 -5.8 L17 12.5 h-2.5 V10 Z',
  harvest: 'M3 20.5 h18 M5 20.5 V13 h5 v7.5 M11.5 13 l5 -3 l4.5 3 v7.5 h-9.5 Z M6.5 16 h2 M14 16 h5',
  map: 'M3 6 l6 -2.5 l6 2.5 l6 -2.5 v15 l-6 2.5 l-6 -2.5 l-6 2.5 Z M9 3.5 v15 M15 6 v15',
  battery: 'M3 8.5 h15 v7 H3 Z M18 11 h2.5 v2.5 H18 M6 10.5 v3 M9.5 10.5 v3',
  feather: 'M19.5 4 q-11 1 -13 12 l-2.5 4.5 M19.5 4 q1.5 9 -6 11 q-4 1 -6.5 -0.5 M13 8.5 l-5 6 M16 6.5 l-3 3.5',
  heart: 'M12 20.5 S3.5 14.8 3.5 9.4 A4.6 4.6 0 0 1 12 6.9 a4.6 4.6 0 0 1 8.5 2.5 c0 5.4 -8.5 11.1 -8.5 11.1 Z',
