/**
 * BattleMapFrame — the schematic battle map, floating over the globe.
 *
 ...
 *
 * Toggled from the battle HUD; draggable by its grip bar.
 */
...
export default function BattleMapFrame({ view, phase, getHeading, onClose }: BattleMapFrameProps) {
  ...
  return (
    <div className="bmap-frame" role="group" aria-label="Battle map">
      <div className="bmap-grip" onPointerDown={(e) => startDrag(e, '.bmap-frame')} title="Drag to move">
        ...
        <button className="bmap-close" onClick={onClose} aria-label="Close battle map">
          ×
        </button>
      </div>
